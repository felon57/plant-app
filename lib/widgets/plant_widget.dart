// new_plant_widget.dart — Small reusable list item for plants
// - Displays price, category, name and thumbnail image.
// - Tapping the item navigates to DetailPage for that plant.
